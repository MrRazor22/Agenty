...
{
    public sealed class GuidedAgent : IAgent
    {
        ...
        public static GuidedAgent Create() => new();
        private GuidedAgent() { }

        public GuidedAgent WithLLM(string baseUrl, string apiKey, string model = "any_model")
        {
        ...
        public GuidedAgent WithTools<T>() { _tools.RegisterAll<T>(); return this; }
        public GuidedAgent WithTools(params Delegate[] fns) { _tools.Register(fns); return this; }
