...
//        private async Task ExecuteToolChaining(ILLMOrchestrator coord, LLMResponse response, Conversation chat)
//        {
//            while (response.ToolCalls.Count != 0)
//            {
//                await HandleToolCalls(coord, response.ToolCalls, chat);
//                response = await coord.GetToolCallResponse(chat);
//            }
//        }

//        private async Task HandleToolCalls(ILLMOrchestrator coord, List<ToolCall> toolCalls, Conversation chat)
//        {
